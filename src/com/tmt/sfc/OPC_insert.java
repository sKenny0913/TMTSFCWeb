 ...
 */
@WebServlet("/Insert_OPC")
public class OPC_insert extends HttpServlet {
...
//		    System.out.println(userAgent);
		...
		String strSQL = config.getString("insert_SQL");
		...
		String strSQLexecute = strSQL + " VALUES ('" + strNodeName.toUpperCase() + "','" + strNodeName.toUpperCase() + "','" + strDataType + "','" + strAddress + "','" + strUserID + "','" + dateFormat.format(date)  + "','" + strDesc  + "')";
