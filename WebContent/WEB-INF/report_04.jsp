<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body class="w3-black">
        ...
        <script src="javascripts/report_04.js"></script>
        ...
        <div class="w3-padding-large" id="main">
            ...
            <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
                <h1 class="w3-xxlarge">Query HDD ID by HDD PN/WO</h1>
                <p></p>
            </header>
            <!-- Contact Section -->
            ...
            <form id="idForm">
                <div class="w3-row-padding" style="margin:8px -16px;">
                    ...
                    <div class="w3-third w3-margin-bottom">
                        <label> HDD PN:</label>
                        <input class="w3-input w3-border" type="text" name="HDD_PN" required> </div>
                </div>
                    ...
                    <a href="#idForm">
                        <table class="w3-table-all w3-light-grey w3-hoverable" id="idStations2">
                            <tr class="w3-large">
                                ...
                                <th onclick="sortTable(1)">HDD_ID</th>
                                <th onclick="sortTable(2)">HDD_PN</th>
                            </tr>
