<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body class="w3-black">
        ...
        <script src="javascripts/report_03.js"></script>
        ...
        <div class="w3-padding-large" id="main">
            ...
            <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
                <h1 class="w3-xxlarge">Testing Data by WO</h1>
                <p></p>
            </header>
            <!-- Contact Section -->
                ...
                <div class="w3-row-padding" style="margin:8px -16px;">
                    ...
                    <div class="w3-quarter w3-margin-bottom">
                        ...
                        <select id="idStationList" class="w3-input w3-border" name="Station" required>
                            <option></option>
                            <option w3-repeat="stationList">{{STATION_NAME}}</option>
                        </select>
                    </div>
                    <div class="w3-quarter w3-margin-bottom">
                        <label> SN:</label>
                    ...
                    <div class="w3-quarter w3-margin-bottom">
                        <label> HDD ID:</label>
                        <input class="w3-input w3-border" type="text" name="HDD_ID" required> </div>
                </div>
                    ...
                    <a href="#idForm">
                        <table class="w3-table-all w3-light-grey w3-hoverable" id="idStations2">
                            <tr class="w3-large">
                                ...
                                <th onclick="sortTable(2)">SN</th>
                                <th onclick="sortTable(3)">HDD_ID</th>
                                <th onclick="sortTable(1)">Station</th>
                                <th onclick="sortTable(4)">Test_Result</th>
                                <th onclick="sortTable(5)">Test_Content</th>
                            </tr>
