<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body class="w3-black">
        ...
        <script src="javascripts/report_01.js"></script>
        ...
        <div class="w3-padding-large" id="main">
            ...
            <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
                <h1 class="w3-xxlarge">SN Traceability by WO and Station</h1>
                <p></p>
            </header>
            <!-- Contact Section -->
            ...
            <form id="idForm">
                <div class="w3-row-padding" style="margin:8px -16px;">
                    ...
                    <div class="w3-quarter w3-margin-bottom">
                        <label> SN Type:</label>
                        <input class="w3-input w3-border" type="text" name="SN_Type" required> </div>
                    <div class="w3-quarter w3-margin-bottom">
                        <label> SN:</label>
                    ...
                    <a href="#idForm">
                        <table class="w3-table-all w3-light-grey w3-hoverable" id="idStations2">
                            <tr class="w3-large">
                                ...
                                <th onclick="sortTable(2)">SN_Type</th>
                                <th onclick="sortTable(3)">SN</th>
                            </tr>
